# `odrupal` Theme
><small>Welcome to `odrupal`, your custom [**Omega Five**](https://drupal.org/project/omega) subtheme! 
...
> You'll find that the `odrupal` theme has a vast coverage of inline documentation. 
...
You will find links to **Install** and **Install and set as default** listed with `odrupal`.

## Customizing Libraries in `odrupal`
...
odrupal:
  omega:
    ...
    title: 'Default library for the odrupal theme'
    description: 'Default Omega subtheme library description. Please provide a more meaningful description (and title) for this library by editing the odrupal.libraries.yml file.'
    scss:
      style/css/odrupal.css: 'style/scss/odrupal.scss'
  version: VERSION
  js:
    js/odrupal.js: {}
  css:
...
Above, you will see the library defined as: `odrupal/odrupal`. 
